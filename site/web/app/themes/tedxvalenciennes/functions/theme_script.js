...
jQuery(document).ready(function(){
	...
	jQuery(".pp_import_demo_button").each(function() {
		jQuery(this).on( 'click', function(){
			var demoKey = jQuery(this).data('key');
			if(demoKey=='')
			{
	        ...
	        jQuery.post(ajaxurl, data, function(response) {
	            jQuery('.import_message').html('<div class="import_message_success">All done. Note: You might want to also <a href="http://themes.themegoods.com/grandconference/doc/import-demo-revolution-sliders/" target="_blank">import demo Revolution Sliders.</a></div>');
	...
	jQuery('#get_styling_color_content li').on( 'click', function(){
		jQuery('#styling_color_message').html('');
		jQuery('#styling_color_message').show();
        ...
        jQuery.post(ajaxurl, data, function(response) {
            jQuery('#styling_color_message').html('<div class="import_message_success">All done!');
            jQuery('#save_ppsettings').show();
        });
	});
    
    jQuery('.pp_get_styling_button').on( 'click', function(){
	    jQuery('#styling_message').html('');
