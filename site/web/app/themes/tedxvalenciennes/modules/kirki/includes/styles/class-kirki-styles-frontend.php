...
if ( ! class_exists( 'Kirki_Styles_Frontend' ) ) {
	...
	class Kirki_Styles_Frontend {
		...
		public function init() {
			...
			$wp_customize = grandconference_get_wp_customize();
				...
				foreach ( $configs as $config_id => $args ) {
					...
					if ( ! empty( $styles ) ) {
						if(is_writable(get_template_directory() . '/modules/kirki/assets/css/kirki-styles.css'))
						{
							...
							wp_enqueue_style( 'kirki-styles-' . $config_id, get_template_directory_uri() . '/modules/kirki/assets/css/kirki-styles.css', null, null ); 
						}
						else
						{
