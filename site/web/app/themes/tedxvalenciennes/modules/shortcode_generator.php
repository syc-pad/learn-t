...
add_action('admin_menu', 'grandconference_shortcode_generator');

function grandconference_shortcode_generator() 
{  
	if ( function_exists('add_meta_box') ) {  
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandconference_shortcode_generator_options', 'page', 'normal', 'default' );
		add_meta_box( 'shortcode_metabox', 'Shortcode Options', 'grandconference_shortcode_generator_options', 'post', 'normal', 'default' );  
	}
}

function grandconference_shortcode_generator_options() {
	...
	grandconference_aasort($shortcodes,"name");
